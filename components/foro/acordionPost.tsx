...
export default function AcordionPost(props: any) {
    ...
    return (
        <div >
            ...
            <div className="cardBody">
                ...
                <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                    <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
                        <Typography> Características - <b>{nameProd}</b></Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        {renderTables(character, charact, 'character')}
                    </AccordionDetails>
                </Accordion>
                {showItemAccordion()}
            ...
            <div style={{ marginTop: 0 }} className="cardBody" >
                <div className={styleForo.imagePost}>
                    {props.index === 0 ?
                        <img
                            onClick={onShowImg}
                            ref={imgEl}
                            src={props.index === 0 ? '' : props.img}
                            className={styleForo.imageCreate} /> :
                        <Image
